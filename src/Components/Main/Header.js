        ...
        <S.HeaderSubBox>
          ...
          <S.SeachBar>
            <form onSubmit={onSubmit}>
              <S.SeachBarSelect onClick={onlist}>
                <S.SeachChoice style={{ color: color }}>
                  <img src={img} alt="검색" />
                  {searchtype}
                </S.SeachChoice>
                {show && (
          ...
          <S.MenuBar>
            <S.MenuUl>
              ...
              <S.MenuList>
                <Link to={"/report-writing"}>보고서 등록</Link>
              </S.MenuList>
              <S.MenuList onMouseEnter={onReportUp} onMouseLeave={onReportDown}>
                ...
                {report && (
                  <S.MenuSee>
                    <Link
                      to={`/view-report/report/filter?size=6&page=1&type=&field=&grade=GRADE1`}
                    >
                      <S.ReportSee>1학년</S.ReportSee>
                    </Link>
                    <Link
                      to={`/view-report/report/filter?size=6&page=1&type=&field=&grade=GRADE2`}
                    >
                      <S.ReportSee>2학년</S.ReportSee>
                    </Link>
                    <Link
                      to={`/view-report/report/filter?size=6&page=1&type=&field=&grade=GRADE3`}
                    >
              ...
              {isAccessToken && isRefrechToken ? (
                <S.MenuList
                  onMouseEnter={onProfileUp}
                  onMouseLeave={onProfileDown}
                >
                  <S.Profile>프로필</S.Profile>
                  {profile && (
                    <S.Mypage>
                      <S.Mypro>
                        <Link to={"/my-profile"}>MYPAGE</Link>
                      </S.Mypro>
